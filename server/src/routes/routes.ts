...
const models: TsoaRoute.Models = {
    "IClient": {
        "dataType": "refObject",
        "properties": {
            "id_client": {"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}]},
            "name": {"dataType":"string","required":true},
            "email": {"dataType":"string","required":true},
            "phone": {"dataType":"string","required":true},
            "coordinate_x": {"dataType":"double","required":true},
            "coordinate_y": {"dataType":"double","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/clients',
            ...
            const args = {
                    client: {"in":"body","name":"client","required":true,"ref":"IClient"},
            };
        ...
        app.get('/clients',
            ...(fetchMiddlewares<RequestHandler>(ClientsController)),
            ...(fetchMiddlewares<RequestHandler>(ClientsController.prototype.getClients)),

            function ClientsController_getClients(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/clients/search',
            ...(fetchMiddlewares<RequestHandler>(ClientsController)),
            ...(fetchMiddlewares<RequestHandler>(ClientsController.prototype.searchClients)),

            function ClientsController_searchClients(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.searchClients.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/clients/:id_client',
            ...(fetchMiddlewares<RequestHandler>(ClientsController)),
            ...(fetchMiddlewares<RequestHandler>(ClientsController.prototype.deleteClient)),

            function ClientsController_deleteClient(request: any, response: any, next: any) {
            const args = {
                    id_client: {"in":"path","name":"id_client","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/clients/shortest-route',
            ...(fetchMiddlewares<RequestHandler>(ClientsController)),
            ...(fetchMiddlewares<RequestHandler>(ClientsController.prototype.getShortestRoute)),

            function ClientsController_getShortestRoute(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getShortestRoute.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
